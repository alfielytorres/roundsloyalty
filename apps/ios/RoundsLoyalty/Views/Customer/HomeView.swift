...
struct HomeView: View {
    ...
    private func loadData() async {
        ...
        async let membershipsTask: [Membership] = (try? await supabase.database
            ...
            .select("*, vendors(id, business_name, brand_color, logo_url, stamp_icon, card_background_url, stamp_bg_color, card_front_url, card_front_headline, card_front_subtext, card_back_message), loyalty_programs(id, name, rounds_required, reward_name, default_round_value)")
