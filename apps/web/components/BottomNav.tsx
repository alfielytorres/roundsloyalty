...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 bg-[#0D0F1A]/90 backdrop-blur-xl border border-white/[.08] rounded-full px-4 py-3 shadow-2xl">
          ...
          return (
            <Link
              ...
              className={`flex items-center justify-center w-14 h-14 -mt-8 rounded-full shadow-xl transition-all mx-3 ${
                scanActive
                  ? 'bg-[#8B5CF6] shadow-[0_0_24px_rgba(139,92,246,0.6)]'
                  : 'bg-[#8B5CF6] shadow-[0_0_16px_rgba(139,92,246,0.35)] hover:shadow-[0_0_24px_rgba(139,92,246,0.55)]'
              }`}
            >
