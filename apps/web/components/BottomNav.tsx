...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 bg-[#111]/80 backdrop-blur-xl border border-white/[.08] rounded-full px-4 py-3 shadow-2xl">
