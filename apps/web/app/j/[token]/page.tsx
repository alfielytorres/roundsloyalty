...
// camera (the Weekends Club app's in-app scanner short-circuits the same URL into a
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 bg-[#F5F5F7]">
      <div className="w-full max-w-xs flex flex-col items-center text-center">
        <Image src="/logo.svg" alt="Weekends Club" width={56} height={56} unoptimized className="mb-4 rounded-xl" />
          ...
          <>
            ...
            <div className="mt-7 w-full glass p-5 text-left">
              <ol className="text-sm text-black/60 flex flex-col gap-3">
                <li><span className="font-semibold text-[#1D1D1F]">1.</span> Get the <span className="font-semibold text-[#1D1D1F]">Weekends Club</span> app and sign up.</li>
            ...
            >
              Open the Weekends Club app
            </a>
            <p className="text-center text-xs text-black/25 mt-3">
              Don&apos;t have it yet? Weekends Club for iPhone is coming to the App Store.
            </p>
          </>
        ) : (
          <>
