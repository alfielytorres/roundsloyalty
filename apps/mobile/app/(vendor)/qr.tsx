  ...
  if (!vendor) {
    return (
      <View style={styles.center}>
        <Text style={styles.noVendorText}>Set up your store in Settings first.</Text>
      </View>
    )
  }
    ...
    return (
      <View style={styles.successContainer}>
        ...
        <TouchableOpacity style={styles.doneBtn} onPress={reset}>
          <Text style={styles.doneBtnText}>Stamp another</Text>
        </TouchableOpacity>
      </View>
    )
  }
  ...
  return (
    ...
    >
      ...
      <View style={styles.modeToggle}>
        ...
        >
          <Text style={[styles.modePillText, mode === 'scan' && styles.modePillTextActive]}>
            Scan QR
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={[styles.modePillText, mode === 'manual' && styles.modePillTextActive]}>
            Enter token
          </Text>
        </TouchableOpacity>
      </View>
      ...
      {mode === 'scan' ? (
        ...
        <View style={styles.manualWrap}>
          ...
          />
          <TouchableOpacity
            style={[styles.stampBtn, (!manualToken.trim() || state === 'processing') && styles.stampBtnDisabled]}
            onPress={() => stamp(manualToken)}
            disabled={!manualToken.trim() || state === 'processing'}
          >
            {state === 'processing' ? (
              <ActivityIndicator color={Colors.white} />
            ) : (
              <Text style={styles.stampBtnText}>Give Stamp</Text>
            )}
          </TouchableOpacity>
        </View>
      )}
