    ...
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .select(`
          ...
          loyalty_balances (stamps_collected, total_visits)
        `)
    ...
    return (
      <View style={styles.empty}>
        ...
        <Text style={styles.emptyText}>
          Ask a participating store to add you, or use the Discover tab to find stores near you.
        </Text>
      </View>
    )
  }
        ...
        ListEmptyComponent={
          pendingMemberships.length === 0 ? (
            <View style={styles.emptyInner}>
              <Text style={styles.emptyText}>No active memberships yet.</Text>
            </View>
          ) : null
        }
        renderItem={({ item }) => {
        ...
        <View style={styles.modalBackdrop}>
          ...
          <View style={styles.modalCard}>
            ...
            <View style={styles.qrLarge}>
              {selected && (
                <QRCode value={selected.membership_token} size={240} color="#000000" backgroundColor="#FFFFFF" />
              )}
            </View>
